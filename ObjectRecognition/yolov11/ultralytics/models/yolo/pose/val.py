...
class PoseValidator(DetectionValidator):
    ...
    def __init__(self, dataloader=None, save_dir=None, args=None, _callbacks=None, cfg_path=None) -> None:
        """
        ...
        """
        super().__init__(dataloader, save_dir, args, _callbacks, cfg_path)
        self.sigma = None
        self.kpt_shape = None
        self.args.task = "pose"
